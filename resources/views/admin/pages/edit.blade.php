...
@section('page-title', 'تعديل: ' . $page->title)
        ...
        <div class="bg-white rounded-lg shadow p-6 space-y-6">
            ...
            <div>
                ...
                <textarea name="content" id="content" rows="10" required
                          class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-indigo-500">{{ old('content', $page->content) }}</textarea>
            </div>
