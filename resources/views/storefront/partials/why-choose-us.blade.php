...
<section class="py-20 bg-gradient-to-br from-primary-blue via-primary-blue to-blue-900 relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10">
        ...
        <div class="text-center mb-16">
            ...
            <h2 class="text-3xl md:text-4xl font-bold text-white mb-4">لماذا تختار مكتبة الصديق؟</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="group relative bg-white/10 backdrop-blur-sm rounded-2xl p-6 hover:bg-white transition-all duration-500 transform hover:-translate-y-2 border border-white/20 hover:border-transparent hover:shadow-2xl">
                ...
                <div class="relative mb-5">
                    <div class="w-16 h-16 bg-gradient-to-br {{ $b['color'] }} rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                        <i class="fas {{ $b['icon'] }} text-2xl text-white"></i>
                    </div>
                    <!-- Number Badge -->
                    <span class="absolute -top-2 -right-2 w-7 h-7 bg-primary-yellow text-primary-blue text-sm font-bold rounded-full flex items-center justify-center shadow">
                        {{ $index + 1 }}
                    </span>
                </div>
                
                <!-- Title -->
                <h3 class="text-xl font-bold text-white group-hover:text-primary-blue mb-3 transition-colors">
                    {{ $b['title'] }}
                </h3>
