        ...
        <div class="bg-white rounded-lg shadow p-6 space-y-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="color" name="banner_color_from" id="banner_color_from" value="{{ old('banner_color_from', '#003399') }}"
                ...
                <div>
                    ...
                    <input type="color" name="banner_color_to" id="banner_color_to" value="{{ old('banner_color_to', '#003D7A') }}"
                           class="w-full h-10 border border-gray-300 rounded-lg px-2 py-1">
                </div>
            </div>
            <div>
